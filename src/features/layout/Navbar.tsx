...
import { DrawerLoginForm } from '@/components/auth/LoginForm'
...
export const Navbar = () => {
    ...
    const headerClassName = clsx(
        'fixed bg-background z-50 border-b-accent h-[70px] w-full duration-300 transition-all',
    ...
    return (
        <header className={headerClassName}>
            <nav className={`border-gray-200  z-50 w-full h-full flex`}>
                <div className=" flex flex-wrap items-center justify-between  w-full">
                    <div className='pl-4'>
                        <Logo />
                    </div>
                    <div className="flex p-4 items-center md:order-2 space-x-2  md:space-x-2 rtl:space-x-reverse">
                    <DrawerLoginForm buttonStyle={'outline'} buttonContent="Login" />
                        <ToggleTheme />
